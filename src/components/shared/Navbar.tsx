...
const Navbar = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full">
      ...
      <div className="bg-[#A7F3D0] py-2 text-center text-[10px] md:text-sm font-bold uppercase tracking-wider text-black">
        <p>The Category Leaderboard - Live Now</p>
      </div>

      {/* Main Navigation */}
      <nav className="flex items-center justify-between px-6 py-4 md:px-12 backdrop-blur-sm bg-black/5">
        {/* Logo */}
